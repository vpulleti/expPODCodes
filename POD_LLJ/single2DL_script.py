...
# base case
bin_path = "/scratch/bell/vpulleti/LLJ_PIV/binary/single_2D_L/single_2D_L_"
ascii_path = "/scratch/bell/vpulleti/LLJ_PIV/single_2D_L/"
plot_path = "/scratch/bell/vpulleti/LLJ_PIV/binary/single_2D_L/"
prefix = "Single_2D_L"
bin_name ="/scratch/bell/vpulleti/LLJ_PIV/binary/single_2D_L/single_2D_L_" # path name can be changed to directory where you want to store the binary files
