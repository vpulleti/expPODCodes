...
# base case
bin_path = "/scratch/bell/vpulleti/LLJ_PIV/binary/array_L/array_L_"
ascii_path = "/scratch/bell/vpulleti/LLJ_PIV/array_L/"
plot_path = "/scratch/bell/vpulleti/LLJ_PIV/binary/array_L/"
prefix = "array_7D_L"
bin_name ="/scratch/bell/vpulleti/LLJ_PIV/binary/array_L/array_L_" # path name can be changed to directory where you want to store the binary files
