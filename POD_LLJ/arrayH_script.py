...
# base case
bin_path = "/scratch/bell/vpulleti/LLJ_PIV/binary/array_H/array_H_"
ascii_path = "/scratch/bell/vpulleti/LLJ_PIV/array_H/"
plot_path = "/scratch/bell/vpulleti/LLJ_PIV/binary/array_H/"
prefix = "array_7D_H"
bin_name ="/scratch/bell/vpulleti/LLJ_PIV/binary/array_H/array_H_" # path name can be changed to directory where you want to store the binary files
