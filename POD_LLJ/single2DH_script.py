...
# base case
bin_path = "/scratch/bell/vpulleti/LLJ_PIV/binary/single_2D_H/single_2D_H_"
ascii_path = "/scratch/bell/vpulleti/LLJ_PIV/single_2D_H/"
plot_path = "/scratch/bell/vpulleti/LLJ_PIV/binary/single_2D_H/"
prefix = "single_2D_H"
bin_name ="/scratch/bell/vpulleti/LLJ_PIV/binary/single_2D_H/single_2D_H_" # path name can be changed to directory where you want to store the binary files
