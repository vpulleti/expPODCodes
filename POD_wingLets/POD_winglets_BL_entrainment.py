...
del out
# reading the data
inlet_Ascii = "/scratch/bell/vpulleti/winglet_data/Inlet_BL/"
inlet_path = "/scratch/bell/vpulleti/winglet_data/binary/inlet/"
inlet_bin = "/scratch/bell/vpulleti/winglet_data/binary/inlet/inlet_"
...
yTip_indx = np.abs(Y_norm[10,:]-1).argmin()
